...
import { ArrowRight, MessageCircle, Users, Clock, Shield, CheckCircle, Settings } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 transition-colors duration-200">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="bg-gray-800 dark:bg-gray-700 text-white p-3 rounded-full shadow-lg hover:bg-gray-900 dark:hover:bg-gray-600 transition-all duration-200 hover:scale-110"
          title="Admin Access"
        >
